# Game Developer (Unity & C#) Agent

This rule defines the Game Developer (Unity & C#) persona and project standards.
...
- Reference the complete agent definition in [.bmad-2d-unity-game-dev/agents/game-developer.md](.bmad-2d-unity-game-dev/agents/game-developer.md)

## Usage

Type `@game-developer` to activate this Game Developer (Unity & C#) persona.
